...
//     let first_line = &content[..5];
//     println!("First 5 chars: {}", first_line);

//     let mutable_ref = &mut content;
//     mutable_ref.push_str("\ni mean cracker guy how are you!");
//     println!("Final content: {}, ", mutable_ref)
// }
// // rust constant
// fn constant() {
